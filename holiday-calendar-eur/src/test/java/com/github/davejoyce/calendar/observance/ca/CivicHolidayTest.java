...
public class CivicHolidayTest extends AbstractObservanceTest {
    ...
    protected List<Object[]> createData() {
        ...
        data.add(new Object[]{ 1976, LocalDate.of(1976, Month.AUGUST, 2) });
        data.add(new Object[]{ 1977, LocalDate.of(1977, Month.AUGUST, 1) });
        data.add(new Object[]{ 1990, LocalDate.of(1990, Month.AUGUST, 6) });
        data.add(new Object[]{ 2021, LocalDate.of(2021, Month.AUGUST, 2) });
        data.add(new Object[]{ 2022, LocalDate.of(2022, Month.AUGUST, 1) });
