...
public class PresidentsDayTest extends AbstractObservanceTest<PresidentsDay> {

    public PresidentsDayTest() {
        super(new PresidentsDay());
    }

    @Override
    protected List<Object[]> createData() {
        List<Object[]> data = new ArrayList<>();
        data.add(new Object[]{ 1878, null });
        data.add(new Object[]{ 1879, LocalDate.of(1879, Month.FEBRUARY, 22) });
        data.add(new Object[]{ 1970, LocalDate.of(1970, Month.FEBRUARY, 22) });
