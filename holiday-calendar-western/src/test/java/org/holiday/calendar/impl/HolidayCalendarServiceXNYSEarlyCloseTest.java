...
/**
 * Tests for the {@code XNYS} calendar's early-close (NYSE half-day closure)
 ...
 * the UK's early closes, which always occur exactly twice per year, the NYSE
 ...
 * fixed count.
 */
public class HolidayCalendarServiceXNYSEarlyCloseTest {
    ...
    private final HolidayCalendarServiceXNYS service = new HolidayCalendarServiceXNYS();
    ...
    public void testEarlyCloseCountForYear(int year, boolean july3Present, boolean dec24Present, int expectedCount) {
        ...
        assertEquals(earlyCloses.size(), expectedCount, "XNYS " + year +": unexpected early-close count");
    }
    ...
    public void testJulyThirdPresenceForYear(int year, boolean july3Present, boolean dec24Present, int expectedCount) {
        ...
        assertEquals(names.contains("July 3rd"), july3Present,
                "XNYS " + year +": July 3rd presence must match July 4 day-of-week rule");
    }
    ...
    public void testChristmasEveEarlyClosePresenceForYear(int year, boolean july3Present, boolean dec24Present, int expectedCount) {
        ...
        assertEquals(names.contains("Christmas Eve"), dec24Present,
                "XNYS " + year +": Christmas Eve presence must match December 25 day-of-week rule");
    }
    ...
    public void testNoDateCollisionBetweenFullDayAndEarlyClose(int year, boolean july3Present, boolean dec24Present, int expectedCount) {
        ...
        assertTrue(intersection.isEmpty(),
                "XNYS " + year +": dates must not appear in both calculate() and calculateEarlyCloses(): " + intersection);
    }
