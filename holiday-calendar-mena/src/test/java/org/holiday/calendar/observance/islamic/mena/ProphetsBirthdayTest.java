...
public class ProphetsBirthdayTest {
    ...
    public void attachLogAppender() {
        observanceLogger = (Logger) LoggerFactory.getLogger(ProphetsBirthday.class);
    ...
    Iterator<Object[]> knownDatesAE() {
        return List.of(
            new Object[]{2024, LocalDate.of(2024, 9, 15)},
            new Object[]{2025, LocalDate.of(2025, 9, 4)},
            new Object[]{2055, LocalDate.of(2055, 9, 22)}
        ).iterator();
    }

    @Test(dataProvider = "knownDatesAE")
    public void testKnownDatesAE(int year, LocalDate expected) {
        assertEquals(new ProphetsBirthday("AE").apply(year), expected);
    }

    @Test
    public void testCeilingYearReturnsDate() {
        assertNotNull(new ProphetsBirthday("AE").apply(ProphetsBirthday.DATA_VALID_THROUGH));
    }

    @Test
    public void testBeyondCeilingReturnsNull() {
        assertNull(new ProphetsBirthday("AE").apply(ProphetsBirthday.DATA_VALID_THROUGH + 1));
    }

    @Test
    public void testBeyondCeilingLogsWarning() {
        new ProphetsBirthday("AE").apply(ProphetsBirthday.DATA_VALID_THROUGH + 1);
    ...
    public void testBelowFloorReturnsNullSilently() {
        assertNull(new ProphetsBirthday("AE").apply(ProphetsBirthday.DATA_VALID_FROM - 1));
    ...
    public void testCaseInsensitiveCountryCode() {
        assertEquals(new ProphetsBirthday("ae").apply(2025), new ProphetsBirthday("AE").apply(2025));
    }
}
