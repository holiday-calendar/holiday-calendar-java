...
public class IslamicNewYearTest {
    ...
    public void attachLogAppender() {
        observanceLogger = (Logger) LoggerFactory.getLogger(IslamicNewYear.class);
    ...
    Iterator<Object[]> knownDatesAE() {
        return List.of(
            new Object[]{2024, LocalDate.of(2024, 7, 7)},
            new Object[]{2025, LocalDate.of(2025, 6, 26)},
            new Object[]{2055, LocalDate.of(2055, 7, 14)}
        ).iterator();
    }

    @Test(dataProvider = "knownDatesAE")
    public void testKnownDatesAE(int year, LocalDate expected) {
        assertEquals(new IslamicNewYear("AE").apply(year), expected);
    }

    @Test
    public void testCeilingYearReturnsDate() {
        assertNotNull(new IslamicNewYear("AE").apply(IslamicNewYear.DATA_VALID_THROUGH));
    }

    @Test
    public void testBeyondCeilingReturnsNull() {
        assertNull(new IslamicNewYear("AE").apply(IslamicNewYear.DATA_VALID_THROUGH + 1));
    }

    @Test
    public void testBeyondCeilingLogsWarning() {
        new IslamicNewYear("AE").apply(IslamicNewYear.DATA_VALID_THROUGH + 1);
    ...
    public void testBelowFloorReturnsNullSilently() {
        assertNull(new IslamicNewYear("AE").apply(IslamicNewYear.DATA_VALID_FROM - 1));
    ...
    public void testCaseInsensitiveCountryCode() {
        assertEquals(new IslamicNewYear("ae").apply(2025), new IslamicNewYear("AE").apply(2025));
    }
}
