...
public class VernalEquinoxDayTest {
    ...
    Iterator<Object[]> knownDates() {
        return List.of(
            new Object[]{1980, LocalDate.of(1980, Month.MARCH, 20)},
            new Object[]{2000, LocalDate.of(2000, Month.MARCH, 20)},
            new Object[]{2024, LocalDate.of(2024, Month.MARCH, 20)},
            new Object[]{2025, LocalDate.of(2025, Month.MARCH, 20)},
            new Object[]{2099, LocalDate.of(2099, Month.MARCH, 20)}
        ).iterator();
    }
    ...
    public void testKnownDates(int year, LocalDate expected) {
        assertEquals(observance.apply(year), expected,
                     "Vernal Equinox Day " + year + " should be " + expected);
    }
